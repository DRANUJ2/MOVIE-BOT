...
API_ID = int(environ.get('API_ID', '27726770'))
API_HASH = environ.get('API_HASH', 'e7e6a5b17c2342a74c43e233cd4ed25b')
BOT_TOKEN = environ.get('BOT_TOKEN', "7340301583:AAHFUK0EBPUNtXF6g2XTpfKcy_3nURuRszc")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5454951641').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002861670672').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002717319391'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002582982387'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002481896248'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002717319391'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002822199906')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1002647843277')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002796809199')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002822199906').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002802028014').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '1002704219638').split()]
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://udaanumeedki11:anujk24680@udaan.msqsgob.mongodb.net/?retryWrites=true&w=majority&appName=udaan")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://nothingxhack:anujk24680@anujkumar.96pqsyb.mongodb.net/?retryWrites=true&w=majority&appName=anujkumar")
DATABASE_NAME = environ.get('DATABASE_NAME', "ANUJ")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'ANUJPRO')
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/FinderRQ')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+GgtaI6g2pUliOGFl')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ANUJVIRUS')
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/FinderRQ')
OWNERID = int(os.environ.get('OWNERID', '5454951641'))  # Replace with the actual admin ID
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/FINDERHELPBOT')  # Support group link (make sure bot is admin)
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'AnujBot'))
MULTI_CLIENT = False
